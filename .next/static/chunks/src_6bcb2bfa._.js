...
"[project]/src/app/actions/loginStudent.ts [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
async function loginEntity({ email, password }) {
    ...
    const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabaseClient$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('users').select('id, nome, email, password_hash') // <-- usa il nome corretto del campo
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$actions$2f$loginStudent$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/app/actions/loginStudent.ts [app-client] (ecmascript)");
    ...
    const handleSubmit = async (e)=>{
        ...
        try {
            if (actionMode === 'register') {
                ...
                if (userType === 'student') {
                    await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$actions$2f$loginStudent$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"])({
                        email: formData.email,
                        password: formData.password
                    });
...
//# sourceMappingURL=src_6bcb2bfa._.js.map